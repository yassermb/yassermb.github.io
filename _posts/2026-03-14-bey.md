...
description: "Why convolutional neural networks struggle with rotations and reflections, and an introduction to equivariant architectures that go beyond classical CNNs."
header:
