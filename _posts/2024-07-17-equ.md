...
date: 2024-07-17
permalink: /posts/2024/07/equ/
description: "An introduction to equivariance and invariance in geometric deep learning, the symmetry groups and mathematical foundations behind models that respect roto-translation of protein structures."
header:
  teaser: /posts/transformations.png
tags:
  - Equivariant
  - Invariant
  - Group theory
...
2. [Geometric Deep Learning](https://geometricdeeplearning.com/)

Here are also some amazing resources from Amsterdam Machine Learning Lab (AMLab) and the University of Amsterdam:

- Hands-on notebooks: [GDL - Regular Group Convolutions](https://uvadlc-notebooks.readthedocs.io/en/latest/tutorial_notebooks/DL2/Geometric_deep_learning/tutorial1_regular_group_convolutions.html) and [Group Equivariant Neural Networks](https://colab.research.google.com/drive/1h7U15-qFC2yy6roRIfLPk5TSlo6sONsm).
- Lectures on [Group Equivariant Deep Learning](https://www.youtube.com/watch?v=z2OEyUgSH2c&list=PL8FnQMH2k7jzPrxqdYufoiYVHim8PyZWd) 

This blog is also nice:

[Geometric Deep Learning: Group Equivariant Convolutional Networks](https://www.youtube.com/watch?v=z2OEyUgSH2c&list=PL8FnQMH2k7jzPrxqdYufoiYVHim8PyZWd)